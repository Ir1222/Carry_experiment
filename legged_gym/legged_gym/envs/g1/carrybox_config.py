...
class G1Cfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        class box:
            ...
            # Long-range carry fine-tuning (temporarily disabled):
    ...
    class rewards( LeggedRobotCfg.rewards ):
        class scales:
            ...
            relocation_task = 1.0
            standup_task = 0.2
            # Long-range carry rewards (temporarily disabled while continuing
            # the original carry-box convergence experiment):
            # carry_progress = 1.0
            # carry_stability = 0.5
        ...
        # Long-range confirmed-carry composition (temporarily disabled):
    ...
    # Long-range navigation configuration (temporarily disabled):
