...
def print_trial_terminal(trial, prefix="BoxPerturb"):
    ...
    print(
        ...
        f"uncapped={float(trial.get('force_uncapped_peak_N', float('nan'))):.4f}N "
        f"peak={float(trial.get('peak_force_N', trial.get('force_peak_N', float('nan')))):.4f}N "
        f"cap={int(trial.get('force_cap_used', 0))} "
        f"impulse={float(trial.get('external_impulse_Ns', float('nan'))):.6f}Ns "
        f"recovery={trial.get('recovery_success', float('nan'))} "
        f"termination={trial.get('termination_reason') or 'none'}"
    )
    print(
        f"[{prefix}:Force] "
        f"L_Fn(pre/pulse/peak/delta)="
        f"{float(trial.get('left_fn_raw_N_pre_mean', float('nan'))):.4f}/"
        f"{float(trial.get('left_fn_raw_N_pulse_mean', float('nan'))):.4f}/"
        f"{float(trial.get('left_fn_raw_N_pulse_peak', float('nan'))):.4f}/"
        f"{float(trial.get('left_fn_raw_N_pulse_delta_from_pre', float('nan'))):.4f}N "
        f"L_Ft={float(trial.get('left_ft_raw_N_pre_mean', float('nan'))):.4f}/"
        f"{float(trial.get('left_ft_raw_N_pulse_mean', float('nan'))):.4f}/"
        f"{float(trial.get('left_ft_raw_N_pulse_peak', float('nan'))):.4f}/"
        f"{float(trial.get('left_ft_raw_N_pulse_delta_from_pre', float('nan'))):.4f}N "
        f"R_Fn={float(trial.get('right_fn_raw_N_pre_mean', float('nan'))):.4f}/"
        f"{float(trial.get('right_fn_raw_N_pulse_mean', float('nan'))):.4f}/"
        f"{float(trial.get('right_fn_raw_N_pulse_peak', float('nan'))):.4f}/"
        f"{float(trial.get('right_fn_raw_N_pulse_delta_from_pre', float('nan'))):.4f}N "
        f"R_Ft={float(trial.get('right_ft_raw_N_pre_mean', float('nan'))):.4f}/"
        f"{float(trial.get('right_ft_raw_N_pulse_mean', float('nan'))):.4f}/"
        f"{float(trial.get('right_ft_raw_N_pulse_peak', float('nan'))):.4f}/"
        f"{float(trial.get('right_ft_raw_N_pulse_delta_from_pre', float('nan'))):.4f}N "
        f"valid={float(trial.get('force_valid_fraction', float('nan'))):.3f}"
    )
